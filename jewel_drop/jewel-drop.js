class JewelDropGame extends Phaser.Scene {
    ...
    activatePhysicsForCrystal(crystal) {
        ...
        console.log(`Activating physics for crystal at (${x.toFixed(1)}, ${y.toFixed(1)}) with radius ${radius}`);
        ...
        // Создаем новый физический кристалл
    ...
    removeMatches(crystals) {
        ...
        crystals.forEach(crystal => {
            ...
            if (currentSize > 1) {
                ...
                const newBody = this.matter.add.circle(x, y, newRadius, {
                    restitution: 0.1,
                    friction: 0.8,
                    frictionAir: 0.02,
                    density: 0.001,
                ...
                crystal.body = newBody;
                newBody.gameObject = crystal;
